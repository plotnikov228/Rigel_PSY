...
class K135Screen extends StatelessWidget {
  TextEditingController group1540Controller = TextEditingController();

  TextEditingController group1538Controller = TextEditingController();

  TextEditingController group664Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1540Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1538Controller,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          CustomTextFormField(
                                            ...
                                            hintText:
                                                "Уныние может быть следствием усталости, неудачных попыток, падений,..- Почему оно возникло у вас?\nСделайте паузу. Остановитесь и побудьте с собой.\nВам необходимо переварить его внутри. Отдохнуть. Выспаться. После отдыха постепенно, в своих возможностях и темпе, плавно набирать активность.",
                                            variant: TextFormFieldVariant
                                                .OutlineBluegray60014,
                                            shape: TextFormFieldShape
                                                .CustomBorderBL3,
                                            padding:
                                                TextFormFieldPadding.PaddingT9,
                                            fontStyle: TextFormFieldFontStyle
