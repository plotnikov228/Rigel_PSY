import '../one9_page/widgets/listsevenhundredfiftyfour_item_widget.dart';
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      "Сделать оскал и порычать. Рычать можно без звука, резко выпуская воздух через зубы",
                                                      maxLines: null,
                                                      textAlign: TextAlign.left,
                                                      style: AppStyle
                              ...
                              Padding(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return ListsevenhundredfiftyfourItemWidget();
                                  },
                                ),
                              ),
                            ],
