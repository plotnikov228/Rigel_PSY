...
class Three8Screen extends StatelessWidget {
  TextEditingController group1559Controller = TextEditingController();

  TextEditingController group1557Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1559Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1557Controller,
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            "Возможно, за отрешенностью скрываются обиды и боль. Возможно, бессознательно пытаетесь избежать чего-то, не сталкиваться. Какое событие произошло или ряд событий в последнее время? Что Вы чувствовали? Распишите список эмоций или по мере выявления, проживайте с упражнениями в приложении. Пишите в дневнике размышления.",
                                                            maxLines: null,
                                                            textAlign:
                                                                TextAlign.left,
                                                            style: AppStyle
