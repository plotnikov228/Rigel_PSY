import '../k91_screen/widgets/listeighthundredsixtyfive_item_widget.dart';
...
class K91Screen extends StatelessWidget {
  TextEditingController group1198Controller = TextEditingController();

  TextEditingController group1196Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1198Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1196Controller,
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          "В моменте: ноги на ширине плеч, прижмите стопы к полу- почувствуйте, как давите на пол. Усильте это давление.",
                                                          maxLines: null,
                                                          textAlign:
                                                              TextAlign.left,
                                                          style: AppStyle
                                    ...
                                    Padding(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          return ListeighthundredsixtyfiveItemWidget();
                                        },
                                      ),
                                    ),
                                    Align(
