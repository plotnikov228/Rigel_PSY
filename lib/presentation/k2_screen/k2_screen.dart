...
import 'package:listenmebaby71_s_application17/presentation/k2_screen/k2_controller.dart';
...
import '../k18_screen/text_field_formatter.dart';
                                        ...
                                        builder: (K2Controller controller) => Column(
                                          children: [
                                            CustomCheckbox(
                                                ...
                                                value: checkbox,
                                                onTapOnText: () => Navigator.pushNamed(context, AppRoutes.k7Screen),
