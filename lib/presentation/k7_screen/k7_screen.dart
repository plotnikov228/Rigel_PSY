  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              CustomButton(
                                  ...
                                  text: AppRoutes.currentRoute == AppRoutes.k6Screen? "настройки".toUpperCase() : "назад".toUpperCase(),
            ...
            bottomNavigationBar:
            AppRoutes.currentRoute == AppRoutes.k6Screen?CustomBottomBar(onChanged: (BottomBarEnum type) {}):null));
  }
