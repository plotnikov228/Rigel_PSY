...
class Five3Page extends StatelessWidget {
  TextEditingController group732Controller = TextEditingController();
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    "Пишите 2 недели в плане на день то, что точно сделате. Включайте кажущиеся несущественными бытовые дела. Принцип и ключевое слово на эти 2 недели- “Достаточно”. Маленькими шагами, без перфекционизма: “Сейчас достаточно”",
                                                    maxLines: null,
                                                    textAlign: TextAlign.left,
                                                    style: AppStyle
