...
class K137Screen extends StatelessWidget {
  TextEditingController group1603Controller = TextEditingController();

  TextEditingController group1601Controller = TextEditingController();

  TextEditingController group725Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1603Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1601Controller,
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            "Меланхолия. Как долго длиться меланхолия?\nЕсли более 2х недель- она может быть признаком клинической депрессии и стоит обратиться за консультацией к неврологу или психиатру.\nПересмотрите, пожалуйста, Ваши цели в жизни. Они точно именно Ваши?\nО чем Вы мечтаете?\nСравните Ваши цели и мечты: они связаны или в разных направлениях?",
                                                            maxLines: null,
                                                            textAlign:
                                                                TextAlign.left,
                                                            style: AppStyle
