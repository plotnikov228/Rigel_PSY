import '../five4_screen/widgets/listonethousandfourhundredfortynine_item_widget.dart';
...
class Five4Screen extends StatelessWidget {
  TextEditingController group1638Controller = TextEditingController();

  TextEditingController group1636Controller = TextEditingController();

  TextEditingController group752Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1638Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1636Controller,
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          "Походите быстро комнате, как зверь в клетке. Сделайте паузу. Если вопрос выбора, ответьте на вопросы: Что будет хорошего, если я это сделаю? Что будет хорошего, если я это не сделаю? Что будет плохого, если я это сделаю? Что будет плохого, если я это не сделаю? \nВ моменте: Пауза. Медленный вдох-выдох ртом. 2-3 раза сжать ладони в кулаки и, раскрывая, расслабить. Улыбнуться уголками рта. ",
                                                          maxLines: null,
                                                          textAlign:
                                                              TextAlign.left,
                                                          style: AppStyle
                                    ...
                                    Padding(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          return ListonethousandfourhundredfortynineItemWidget();
                                        },
                                      ),
                                    ),
                                    Align(
