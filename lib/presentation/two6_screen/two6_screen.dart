import '../two6_screen/widgets/listonethousandfourhundredseventythree_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:listenmebaby71_s_application17/core/app_export.dart';
import 'package:listenmebaby71_s_application17/widgets/custom_bottom_bar.dart';
import 'package:listenmebaby71_s_application17/widgets/custom_text_form_field.dart';
class Two6Screen extends StatelessWidget {
  TextEditingController group1436Controller = TextEditingController();

  TextEditingController group1434Controller = TextEditingController();

  TextEditingController group541Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1436Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1434Controller,
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          "Разделите большое событие или ситуацию на малые, конкретные и понятные. Как разделяете большой кусок еды, так и со следующими действиям: малыми, последовательно.",
                                                          maxLines: null,
                                                          textAlign:
                                                              TextAlign.left,
                                                          style: AppStyle
                                    ...
                                    Padding(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          return ListonethousandfourhundredseventythreeItemWidget();
                                        },
                                      ),
                                    ),
                                    Align(
