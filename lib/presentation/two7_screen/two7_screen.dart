...
class Two7Screen extends StatelessWidget {
  TextEditingController group1589Controller = TextEditingController();

  TextEditingController group1587Controller = TextEditingController();

  TextEditingController group707Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1589Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1587Controller,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              "Напишите списком ответы: Что Вы резко критикуете? Что резко не принимаете в других людях? Силу давления чего Вы испытываете? Что или кого Вы избегаете? Вы можете это постепенно 1) изменить 2) принять 3) поменять среду",
                                              maxLines: null,
                                              textAlign: TextAlign.left,
                                              style: AppStyle
                                                  .txtSFProDisplayLight14
