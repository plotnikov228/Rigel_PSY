import '../four2_page/widgets/listfear_item_widget.dart';
...
class Four2Page extends StatelessWidget {
  TextEditingController group403Controller = TextEditingController();
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            "Осмотритесь вокруг: изучите пространство со всех сторон, начни с пола, поднимая взгляд и рассматривая предметы и их детали: из чего они сделаны, какого цвета.",
                                                            maxLines: null,
                                                            textAlign:
                                                                TextAlign.left,
                                                            style: AppStyle
