...
class Two8Screen extends StatelessWidget {
  TextEditingController group1517Controller = TextEditingController();

  TextEditingController group1515Controller = TextEditingController();

  TextEditingController group639Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1517Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1515Controller,
                                                ...
                                                Container(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          "Вернуть доверие к себе и миру: найти свои точки опоры внутри и снаружи. В конце концов, солнце и луна находятся каждый день, а погода каждый день разная и это нормально. Также и внутри Вас.",
                                                          maxLines: null,
                                                          textAlign:
                                                              TextAlign.left,
                                                          style: AppStyle
