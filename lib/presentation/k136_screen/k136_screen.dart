...
class K136Screen extends StatelessWidget {
  TextEditingController group1390Controller = TextEditingController();

  TextEditingController group1388Controller = TextEditingController();

  TextEditingController group492Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1390Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1388Controller,
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            "Ненужность. Что не додаете самому себе? Что хотите сделать для другого?\nСоставьте список и сделайте это для себя.\nЕсли чувство ненужности связано с реализацией идей, стремлений- постепенно, не спеша, расширяйте свой круг контактов новых, близких по духу людей; теми кому интересна аналогичное направление или область.",
                                                            maxLines: null,
                                                            textAlign:
                                                                TextAlign.left,
                                                            style: AppStyle
