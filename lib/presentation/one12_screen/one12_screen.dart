import '../one12_screen/widgets/listonethousandthreehundredfiftythree_item_widget.dart';
...
import '../tab_container1_page/tab_container1_page.dart';class One12Screen extends StatelessWidget {
  TextEditingController group1413Controller = TextEditingController();

  TextEditingController group1411Controller = TextEditingController();

  TextEditingController group515Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1413Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1411Controller,
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          "К тому, что очень хотите, но этого нет.\nТочно хотите вы или потому что все хотят, считая престижным? Если нет материального- ищите маршрут, как заработать честно.\nЕсли нематериального- какие внутренние качества надо усилить; какие свои уникальные черты есть у Вас для того, чтобы достичь желаемого. Возможно, они требуют своего раскрытия. Развивая и направляя уникальное, можете создавать уникальные ценности.",
                                                          maxLines: null,
                                                          textAlign:
                                                              TextAlign.left,
                                                          style: AppStyle
                                    ...
                                    Padding(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          return ListonethousandthreehundredfiftythreeItemWidget();
                                        },
                                      ),
                                    ),
                                    Align(
