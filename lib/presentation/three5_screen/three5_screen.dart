import '../three5_screen/widgets/listonethousandthreehundredseventyseven_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:listenmebaby71_s_application17/core/app_export.dart';
import 'package:listenmebaby71_s_application17/widgets/custom_bottom_bar.dart';
import 'package:listenmebaby71_s_application17/widgets/custom_text_form_field.dart';

class Three5Screen extends StatelessWidget {
  TextEditingController group1568Controller = TextEditingController();

  TextEditingController group1566Controller = TextEditingController();

  TextEditingController group687Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1568Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1566Controller,
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          "\"Стоп!\" Скажите себе \"СТОП!\" Отрежьте мысль, посмотрите в противоположное направление, возьмите в руки предмет, рассматривая и ощущая пальцами текстуру, смените деятельность.",
                                                          maxLines: null,
                                                          textAlign:
                                                              TextAlign.left,
                                                          style: AppStyle
                                    ...
                                    Padding(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          return ListonethousandthreehundredseventysevenItemWidget();
                                        },
                                      ),
                                    ),
                                    Align(
