...
import 'package:listenmebaby71_s_application17/presentation/k52_screen/widgets/event_change_widget.dart';
import 'package:listenmebaby71_s_application17/presentation/k52_screen/widgets/voice_button.dart';
                      ...
                      EventChangeWidget(
                        ...
                        onAdd: (text) async {
                          var result = (await Navigator.pushNamed(
                              context, AppRoutes.k24Page, arguments: {
                            ...
                            builder: (BuildContext context) => WillPopScope(
                              onWillPop: () async {
                                Navigator.pushNamedAndRemoveUntil(context,
                                    AppRoutes.k49Screen, (route) => false);
                                return true;
                              },
