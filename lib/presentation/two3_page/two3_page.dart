import '../two3_page/widgets/listonethousandonehundredfifty_item_widget.dart';
...
class Two3Page extends StatelessWidget {
  TextEditingController group524Controller = TextEditingController();
                                      ...
                                      child: Padding(
                                        ...
                                        child: ListView.separated(
                                          ...
                                          itemBuilder: (context, index) {
                                            return ListonethousandonehundredfiftyItemWidget();
                                          },
                                        ),
                                      ),
                                    ),
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        "Нарисуйте свою грусть. Карандашом, ручкой, фломастерами и на чем угодно. Рассмотрите её внимательно.. а теперь добавьте пару ярких цветов или смешных элементов. Пририсуйте чашку чая, книгу, цветок- то, что сделает ей приятно)",
                                                        maxLines: null,
                                                        textAlign:
                                                            TextAlign.left,
                                                        style: AppStyle
