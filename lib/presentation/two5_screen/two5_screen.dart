import '../two5_screen/widgets/listonethousandthreehundredtwentynine_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:listenmebaby71_s_application17/core/app_export.dart';
import 'package:listenmebaby71_s_application17/widgets/custom_bottom_bar.dart';
import 'package:listenmebaby71_s_application17/widgets/custom_text_form_field.dart';
class Two5Screen extends StatelessWidget {
  TextEditingController group1503Controller = TextEditingController();

  TextEditingController group1501Controller = TextEditingController();

  TextEditingController group622Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1503Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1501Controller,
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          "Напишите списком то, что стесняетесь или боитесь и зачитайте разными смешными голосами.",
                                                          maxLines: null,
                                                          textAlign:
                                                              TextAlign.left,
                                                          style: AppStyle
                                    ...
                                    Padding(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          return ListonethousandthreehundredtwentynineItemWidget();
                                        },
                                      ),
                                    ),
                                    Align(
