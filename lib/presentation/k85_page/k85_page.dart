...
class K85Page extends StatelessWidget {
  TextEditingController group425Controller = TextEditingController();
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                "Вам не хватает энергии. Для того, чтобы она появилась, необходимо начать её вырабатывать. Запишитесь в спортзал или делайте упражнения дома. Начните с 10 минут каждый день в течении 7 дней. Увеличивайте время на 10 минут каждую неделю до 60 мин, включая пешие прогулки или велосипед- распределите их в течении дня.",
                                                                maxLines: null,
                                                                textAlign:
                                                                    TextAlign
                                                                        .left,
