...
class K86Page extends StatelessWidget {
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              "Что эмоция хочет вам сказать? О чем она? Возьмите несколько листов или тетрадь и пишите все подряд, потоком, как идет- дайте эмоции рассказать и принять новые решения.",
                                                              maxLines: null,
                                                              textAlign:
                                                                  TextAlign
                                                                      .left,
