import '../seven_page/widgets/listonethousandeight_item_widget.dart';
...
class SevenPage extends StatelessWidget {
  TextEditingController group462Controller = TextEditingController();
                                            ...
                                            Padding(
                                              ...
                                              child: ListView.separated(
                                                ...
                                                itemBuilder: (context, index) {
                                                  return ListonethousandeightItemWidget();
                                                },
                                              ),
                                            ),
                                          ],
                                    ...
                                    Align(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          CustomTextFormField(
                                            focusNode: FocusNode(),
                                            controller: group462Controller,
                                            hintText: "Гнев (ярость)",
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      "Возьмите старое полотенце, которое не жалко порвать и тяните, дергайте его в разные стороны со всей силы, пытаясь разорвать, пока не станет отпускать гнев. ",
                                                      maxLines: null,
                                                      textAlign: TextAlign.left,
                                                      style: AppStyle
