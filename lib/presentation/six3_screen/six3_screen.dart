...
class Six3Screen extends StatelessWidget {
  TextEditingController group1645Controller = TextEditingController();

  TextEditingController group1643Controller = TextEditingController();

  TextEditingController group758Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1645Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1643Controller,
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            "Начните с малого: разбора и упорядочивания Ваших предметов: шкаф, стол, сумка, рабочий стол.\nРазбирайте погрузившись максимально в этот процесс и выкидывайте ненужное.\nКогда закончите- посмотрите на результат. Повторяйте регулярно",
                                                            maxLines: null,
                                                            textAlign:
                                                                TextAlign.left,
                                                            style: AppStyle
