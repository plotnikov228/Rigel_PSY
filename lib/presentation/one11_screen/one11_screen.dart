...
class One11Screen extends StatelessWidget {
  TextEditingController group1189Controller = TextEditingController();

  TextEditingController group1187Controller = TextEditingController();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  focusNode: FocusNode(),
                  controller: group1189Controller,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: CustomTextFormField(
                          focusNode: FocusNode(),
                          controller: group1187Controller,
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            "Прострация. Обратитесь к Вашим ценностям. Какие 4 ключевые ценности в Вашей жизни?\nЭти 4 ценности не должны иметь привязку к конкретному человеку или группе лиц, не быть материальными. Например, честность, достоинство, доброта, креативность или семья, как факт, мечта, карьера. Напишите свои 4 основные ценности- это столбы Вашей Личности. 4 точки координат, дающие понять, где Вы находитесь. Обратите свое внимание на них, укрепление внутри себя и проявление их из внутреннего мира во внешний.",
                                                            maxLines: null,
                                                            textAlign:
                                                                TextAlign.left,
                                                            style: AppStyle
