...
class K129Page extends StatelessWidget {
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              "Горечь. Спрячтесь под одеяло, свернитесь колачиком, обняв себя за колени и усильте её до максимума. Если захочется кричать, кричите. Можно кричать в подушку или беззвучно. Будут подступать слезы- разрешите им быть.",
                                                              maxLines: null,
                                                              textAlign:
                                                                  TextAlign
                                                                      .left,
