...
class K133Page extends StatelessWidget {
  TextEditingController group482Controller = TextEditingController();
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                "Найдите новое занятие, которое уже хотели попробовать: рисование, сбор конструкторов, игра на музыкальном инструменте, танцы, дизайн, программирование- любое, что вам интересно или любопытно- увлекитесь!)",
                                                                maxLines: null,
                                                                textAlign:
                                                                    TextAlign
                                                                        .left,
